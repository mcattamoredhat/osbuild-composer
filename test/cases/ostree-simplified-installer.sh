...
# Test IoT/Edge OS
sudo ansible-playbook -v -i "${TEMPDIR}"/inventory -e image_type=redhat -e ostree_commit="${INSTALL_HASH}" -e fdo_credential="true" -e edge_type="edge-simplified-installer" /usr/share/tests/osbuild-composer/ansible/check_ostree.yaml || RESULTS=0
check_result
...
# Test IoT/Edge OS
sudo ansible-playbook -v -i "${TEMPDIR}"/inventory -e image_type=redhat -e ostree_commit="${INSTALL_HASH}" -e fdo_credential="false" -e edge_type="edge-simplified-installer" /usr/share/tests/osbuild-composer/ansible/check_ostree.yaml || RESULTS=0
check_result
...
# Test IoT/Edge OS
sudo ansible-playbook -v -i "${TEMPDIR}"/inventory -e image_type=redhat -e ostree_commit="${UPGRADE_HASH}" -e fdo_credential="false" -e edge_type="edge-simplified-installer" /usr/share/tests/osbuild-composer/ansible/check_ostree.yaml || RESULTS=0
check_result
